...
<body>
    ...
    <main class="Contenido">
        ...
        <h1>Camiseta Super Meat Boy - Meat Boy</h1>
        <div class="camisa">
            <img class="camisa__imagen" src="img/producto5.png" alt="camisa yv">
            <div class="camisa__contenido">
                ...
                <?php }else{ ?>
                    <p>Solo quedan <?php echo $pro6['cantidad']?> disponibles</p>
                <?php
                    } ?>
                <form action="vendeproducto.php" method="post" class="formulario">
                    <input type="hidden" name="cod" value="6"> <!--Para identificar el producto y ejecutar su respectivo if-->
                    <?php
                    if($verificar == true){ ?>
