...
<body>
    ...
    <main class="Contenido">
        ...
        <h1>Camiseta Nuclear Throne - Melting</h1>
        <div class="camisa">
            <img class="camisa__imagen" src="img/producto4.png" alt="camisa yv">
            <div class="camisa__contenido">
                ...
                <?php }else{ ?>
                    <p>Solo quedan <?php echo $pro5['cantidad']?> disponibles</p>
                <?php
                    } ?>
                <form action="vendeproducto.php" method="post" class="formulario">
                    <input type="hidden" name="cod" value="5"> <!--Para identificar el producto y ejecutar su respectivo if-->
                    <?php
                    if($verificar == true){ ?>
