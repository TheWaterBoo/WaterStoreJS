...
<body>
    ...
    <main class="Contenido">
        ...
        <h1>Camiseta Kirby</h1>
        <div class="camisa">
            <img class="camisa__imagen" src="img/producto8.png" alt="camisa kirby">
            <div class="camisa__contenido">
                ...
                <?php }else{ ?>
                    <p>Solo quedan <?php echo $pro1['cantidad']?> disponibles</p>
                <?php
                    } ?>
                <form action="vendeproducto.php" method="post" class="formulario">
                    ...
                    <?php
                    if($verificar == true){ ?>
                        <input class="formulario__campo" type="number" placeholder="Cantidad" min="1" name="cant" id="cant">
                    ...
                    <?php } else { ?>
                        ...
                        <input class="button__disabled" type="submit" disabled value="Comprar">
                    <?php
                        } ?>
                </form>
            </div>
