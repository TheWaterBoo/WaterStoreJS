...
<body>
    ...
    <main class="Contenido">
        ...
        <h1>Camiseta Python</h1>
        <div class="camisa">
            <img class="camisa__imagen" src="img/producto7.png" alt="camisa python">
            <div class="camisa__contenido">
                ...
                <?php }else{ ?>
                    <p>Solo quedan <?php echo $pro8['cantidad']?> disponibles</p>
                <?php
                    } ?>
                <form action="vendeproducto.php" method="post" class="formulario">
                    <input type="hidden" name="cod" value="8"> <!--Para identificar el producto y ejecutar su respectivo if-->
                    <?php
                    if($verificar == true){ ?>
