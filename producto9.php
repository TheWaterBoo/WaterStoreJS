...
<body>
    ...
    <nav class="barra-nav">
        ...
        ?>
            ...
            <a class="barra-nav__link " href="register.php"><img class="alinearImg" src="img/enter.png" alt="logout"> Log out</a>
        <?php
        } else { ?>
    ...
    <main class="Contenido">
        ...
        <h1>Camiseta Ciclo del programador</h1>
        <div class="camisa">
            <img class="camisa__imagen" src="img/producto9.png" alt="camisa cicle">
            <div class="camisa__contenido">
                ...
                <?php }else{ ?>
                    <p>Solo quedan <?php echo $pro9['cantidad']?> disponibles</p>
                <?php
                    } ?>
                <form action="vendeproducto.php" method="post" class="formulario">
                    <input type="hidden" name="cod" value="9"> <!--Para identificar el producto y ejecutar su respectivo if-->
                    <?php
                    if($verificar == true){ ?>
